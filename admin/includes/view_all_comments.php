...
//    exit();
//    DEO ZA BRISANJE COUNTERA U BAZI LOSE JE RESENJE ZATO STO REFRESHOM CAK I DA NEMA POSTA IDE U MINUS BOLJE TRIGER U BAZI!!!
//    $idForDeleting_post_comment_count = $_GET['cc'];
//    $sql_numOfComments = "UPDATE posts SET post_comment_count = post_comment_count - 1 WHERE post_id = $idForDeleting_post_comment_count";
...
<table class="table table-bordered table-hover">
    ...
    while ($row = mysqli_fetch_object($select_posts)) {
        ...
        <tr>
            ...
            <td class="text-center"><a href="comments.php?a=<?= $comment_id ?>">Appruve
                    <i class="fa fa-check" aria-hidden="true"></i></a></td>
            <td class="text-center"><a href="comments.php?u=<?= $comment_id ?>">Unapproved
                    <i class="fa fa-times" aria-hidden="true"></i></a></td>
            <!--            <td class="text-center"><a href="comments.php?e=--><?//= $comment_id ?><!--">Edit <i class="fa fa-pencil" aria-hidden="true"></i></a></td>-->
            <td class="text-center"><a href="comments.php?d=<?= $comment_id ?>&cc=<?= $post_id ?>">Delete
