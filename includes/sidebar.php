<div class="col-md-4">
    <!-- Blog Search Well -->
    <?php
    /*deo gde se pojavljuje edit i remove this post ako si ulogovan*/
...
kraj;
    ...
    <div class="well">
        <!--nismo koristili! lepse ispisivanje uslova bez echo-->
        <?php if (isset($_SESSION['id'])): ?>

            <!--logout ako si ulogovan-->
            <h4>Logged in as <?= $_SESSION['firstname'] ?> <?= $_SESSION['lastname'] ?>! <a href="includes/logout.php" class="btn btn-primary">Logout</a></h4>
